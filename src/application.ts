...
import {RedisPubSubBindings, RedisPubSubComponent, RedisPubSubOptionsKeyBindings} from 'loopback4-redis-pubsub';
...
export class ThirdCircleIoApplication extends BootMixin(SocketIoApplication) {
  ...
  constructor(options: ApplicationConfig = {}) {
    ...
    this.bind(REDIS_PUBSUB_DATA_HANDLER)
      ...
      .tag({
        [RedisPubSubOptionsKeyBindings.NAMESPACE]: RedisPubSubBindings.REDIS_PUBSUB_NAMESPACE,
        [RedisPubSubOptionsKeyBindings.OPTIONS]: {channel: EntityEvent.DataChange},
      })
